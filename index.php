    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse" id="navbarResponsive">
        <ul class="navbar-nav ml-auto">
          <li class="nav-item">
            <a class="nav-link" href="#" data-toggle="modal" data-target="#exampleModal" data-whatever="@mdo">Iniciar Sesión</a>
                  ...
                  <div class="modal-body">
                    <form action="Login.php" method="POST">
                      <div class="form-group">
                        ...
                        <input type="text" name="inputCorreo" class="form-control" id="r">
                      </div>
                      <div class="form-group">
                        <label for="message-text" class="control-label">Contraseña:</label>
                        <input type="password" name="inputPass" class="form-control" id="r2">
                      </div>
          ...
          <li class="nav-item">
            <a class="nav-link" href="#" data-toggle="modal" data-target="#exampleModal2" data-whatever="@mdo">Registrarse</a>
                  ...
                  <div class="modal-body">
                    <form action="Registrar.php" method="POST">
                      <div class="form-group">
                        ...
                        <input type="text" id="inputNombre" name="inputNombre"  class="form-control" id="r">
                      </div>
                      <div class="form-group">
                        <label for="recipient-name"  class="control-label">Correo:</label>
                        <input type="email" id="inputCorreo" name="inputCorreo" class="form-control" id="r">
                      </div>
                      <div class="form-group">
                        <label for="message-text" class="control-label">Contraseña:</label>
                        <input type="password" id="inputPass" name="inputPass" class="form-control" id="r2">
                      </div>
  ...
  <header class="masthead text-center text-white">
    <div class="masthead-content">
      <div class="container">
        ...
        <h2 class="masthead-subheading mb-0">Alcaldia de Cúcuta</h2><br><br>
        <a href="#" class="btn btn-primary btn-xl rounded-pill mt-5">Aprender</a>
      </div>
    </div>
